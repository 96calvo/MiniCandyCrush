...
public:
	...
	void Rotate(Transform &transform,ObjectID objectID, SDL_RendererFlip flip) {
		auto center = SDL_Point{ transform.x, transform.y };
		SDL_RenderCopyEx(m_SDLRenderer, m_textureData[objectID], NULL, &transform.rect, 0, &center, flip);
